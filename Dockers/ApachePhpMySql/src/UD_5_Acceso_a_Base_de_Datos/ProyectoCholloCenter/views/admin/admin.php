<?php
    ...
    {
        if ($_COOKIE['role'] === 'admin') // Comprovamos que sea un usuario
        {
            $conexion = null;
            ...
            try {
                ...
                $sql = 'SELECT * FROM chollos'; // Sentencia para obtener el id del usuario
    ...
    function authorName($id_author) 
    {
        ...
        try {
            ...
            $sql = 'SELECT username FROM users WHERE id = :id_author'; // Sentencia para obtener el id del usuario

            $sentencia = $conexion->prepare($sql);
            $sentencia->bindParam(':id_author', $id_author);
            ...
            <?php foreach ($chollos as $chollo): ?>
                <div class="chollo-card">
                    ...
                    <div class="chollo-content">
                        ...
                        <p class="chollo-author">Author: <?= authorName($chollo['created_by']) ?></p>
                    </div>
